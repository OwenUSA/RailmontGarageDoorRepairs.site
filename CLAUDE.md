# CLAUDE.md — Railmont Garage Door Repairs, clone-and-adapt build chain
...
the coordinates are real Fort Mill, SC coordinates and the map is embedded by coordinates
...
- **Proposition category** (Prompt 3, item 3): **workmanship — the repair holds up.**
  Held across all five routes. Do not lead on speed.
