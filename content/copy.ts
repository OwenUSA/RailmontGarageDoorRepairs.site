  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'What happens to what you type. The form has no submission target. Nothing typed into it is transmitted off the device it was typed on, and nothing is written to a server, because there is no server behind the form to write to. On sending, the page shows a confirmation and the details stay in the browser tab until it is closed or refreshed.',
